#ifndef _HEAP_H // precompiler directives
// if _HEAP_H does not exist, then define it with this code
#define _HEAP_H
...
class heap{
    ...
    private:
        ...
        int capacity;
        int currentSize;
        std::vector<node> data; //actual entries  of heap, same as hashtable?
        hashTable mapIdNode; //pointer to hashtable
